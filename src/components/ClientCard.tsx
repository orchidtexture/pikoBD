...
export const ClientCard: React.FC<ClientCardProps> = ({
  ...
  const isCheckedThisWeek = lastNeedsCheck && isSameWeek(new Date(lastNeedsCheck.date), new Date());
      ...
      <div className="p-5 md:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div>
            ...
            <div className="flex flex-col mt-2 text-xs md:text-sm text-slate-500 gap-4">
              ...
              <div className="flex justify-between items-center">
                ...
                {isCheckedThisWeek ? (
                  ...
                  <span className="flex items-center gap-1 text-amber-500 font-medium italic">
                    <Zap className="w-3 h-3" />
